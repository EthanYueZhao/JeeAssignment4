...
<td>Course title</td>
<td>
<input type="text" name="courseTitle" value="${sessionScope.course.courseTitle}" /> 
</td>
</tr><tr>
...
<c:otherwise>
<option value = "${sessionScope.course.professor}" selected>${sessionScope.course.professor} </option>
